...
# CONFIGURAÇÕES
# ==============================================================================
# IMPORTANTE: Nome exato do arquivo no GitHub
...
# ... (As funções auxiliares limpar_string e encontrar_nome_csv continuam iguais) ...
...
def get_adamchoi_corners():
    ...
    try:
        ...
        # Tenta ler com lxml, se falhar tenta bs4 (fallback de segurança)
        try:
...
def main():
    ...
    try:
        # AQUI ESTAVA O ERRO: Agora lê o nome certo
